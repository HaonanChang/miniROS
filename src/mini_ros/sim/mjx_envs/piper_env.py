...
class PiperEnv(gym.Env):
    ...
    def step(self, action):
        self.data.qpos[0:7] = action
        self.data.qpos[7] = action[-1]  # Right gripper is copy of left gripper
